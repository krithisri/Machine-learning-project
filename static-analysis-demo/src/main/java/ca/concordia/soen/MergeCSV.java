...
public class MergeCSV {
    public static void main(String[] args) throws Exception {
        // Read the first file
        BufferedReader reader1 = new BufferedReader(new FileReader("C:\\Users\\Admin\\eclipse-workspace\\Assignment\\src\\Assignment\\src\\Files\\Final\\Understand.csv"));
        ...
        BufferedReader reader2 = new BufferedReader(new FileReader("C:\\Users\\Admin\\eclipse-workspace\\Assignment\\src\\Assignment\\src\\Files\\Final\\abcd.csv"));
...
//            System.exit(0);
            ...
            if (values2 == null) {
                values2 = new String[] { key, "0","0" };
            }
            if (values3 == null) {
                values3 = new String[] { key, "0"};
            }
            if (values4 == null) {
                values4 = new String[] { key, "0"};
            }
            String[] mergedValues = new String[47];
            ...
            mergedValues[43] = values2[1];
            mergedValues[44] = values2[2];
            mergedValues[45] = values3[1];
            mergedValues[46] = values4[1];
